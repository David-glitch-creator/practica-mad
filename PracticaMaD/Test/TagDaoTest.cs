...
namespace Es.Udc.DotNet.PracticaMaD.Test
{
    ...
    public class TagDaoTest
    {
        ...
        private const String tagName2 = "etiqueta2";
        ...
        public void MyTestInitialize()
        {
            ...
            tag2 = new Tag();
            tag2.tagName = tagName2;
            tag2.taggedImagesNumber = 0;
        ...
        [TestMethod()]
        public void TagImage_FindAllOrderByPopularity()
        {
            tagDao.TagImage(tag2, imageEntity);

            List<Tag> actual = tagDao.FindAllOrderByPopularity();
